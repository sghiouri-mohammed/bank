                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="form-group">
                                    <label>Login</label>
                                    <input type="password" class="form-control" name="pwd" placeholder="Enter new password" required>
                                </div>
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $use = $_POST['pwd'];
                                $agents = $emp_cntr->modify_agent_conseiller_password($_GET["idEmp"],$use);
                                if ($_GET["idCateg"] == 0){
