        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">Effectuer Depôt</h3>
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <label>Montant de date_parse_from_format</label>
                        ...
                        // Assuming you have form input for username and password
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if ($operation_controller->effectuer_operation_depot($montant, 'Depot', $_GET["idClient"], $idCompte)){
                                    $compte_controller->update_solde_compte($idCompte, $montant);
                                    echo " <p class='success-message'> Dépot avec success </p>"; 
                                }
                                }
